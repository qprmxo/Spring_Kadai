...
<title>Spring_Kadai_Update</title>
...
<div align="center">
	...
	<form action="update" id="frm" method="post">
		<table border="1">
			...
			<tr>
				<th>生年月日</th><td><input type="date" name="birth" id="birth" value="${userdetail.birth }"></td>
			</tr>
			<tr>
				<th>委員会</th><td><input type="text" name="club" id="club" value="${userdetail.club }"></td>
			</tr>
		</table>
		
		<input type="hidden" name="cmd" value="updateCheck">
